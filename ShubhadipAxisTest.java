...
public class ShubhadipAxisTest {
	public static void main(String args[]) {
		WebDriver w = new ChromeDriver();
		System.out.println("Open chromeDriver successfully");
		  w.get("https://testautomationpractice.blogspot.com/");
		  w.findElement(By.id("name")).sendKeys("SHUBHADIP PAUL");
		  w.findElement(By.id("email")).sendKeys("shubhadippaul432@gmail.com");
		  w.findElement(By.id("phone")).sendKeys("7479394579");
		  w.findElement(By.id("textarea")).sendKeys("Coochbehar WestBengal");
		  w.findElement(By.xpath("//*[@id=\"male\"]")).click();
